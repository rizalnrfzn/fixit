...
class _$GeolocationImpl implements _Geolocation {
  _$GeolocationImpl({this.location, this.placemark});
  ...
  @override
  String toString() {
    return 'Geolocation(location: $location, placemark: $placemark)';
  }
...
abstract class _Geolocation implements Geolocation {
  factory _Geolocation({final LatLng? location, final Placemark? placemark}) =
      _$GeolocationImpl;
