...
class _$ChatListImpl extends _ChatList {
  _$ChatListImpl(
      {this.id,
      this.clientUid,
      this.clientUnread,
  ...
  @override
  String toString() {
    return 'ChatList(id: $id, clientUid: $clientUid, clientUnread: $clientUnread, technicianUid: $technicianUid, technicianUnread: $technicianUnread, lastSender: $lastSender, lastMessage: $lastMessage, lastTime: $lastTime, chats: $chats)';
  }
...
abstract class _ChatList extends ChatList {
  factory _ChatList(
      {final String? id,
      final String? clientUid,
      final int? clientUnread,
      ...
      final String? lastMessage,
      final DateTime? lastTime,
      final List<Chat>? chats}) = _$ChatListImpl;
  _ChatList._() : super._();
