...
class _$ClientImpl implements _Client {
  _$ClientImpl({this.uid, this.name, this.profilePicture});
  ...
  @override
  String toString() {
    return 'Client(uid: $uid, name: $name, profilePicture: $profilePicture)';
  }
...
abstract class _Client implements Client {
  factory _Client(
      {final String? uid,
      final String? name,
      final String? profilePicture}) = _$ClientImpl;
