...
class _$GeolocationModelImpl extends _GeolocationModel {
  _$GeolocationModelImpl({this.location, this.placemark}) : super._();
  ...
  @override
  String toString() {
    return 'GeolocationModel(location: $location, placemark: $placemark)';
  }
...
abstract class _GeolocationModel extends GeolocationModel {
  factory _GeolocationModel(
      {final LatLng? location,
      final Placemark? placemark}) = _$GeolocationModelImpl;
